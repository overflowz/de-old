...
export declare const createDomainEvent: <T extends IDomainEvent<object, object>>({ name, params, state, parent, }: CreateDomainEventArgs<T>) => Pick<T, "id" | "parent" | "name" | "params" | "errors" | "createdAt" | "executedAt" | "completedAt" | "state">;
