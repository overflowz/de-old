...
export declare const createDomainEvent: <T extends IDomainEvent<{}, {}>>({ name, params, state, parent, }: CreateDomainEventArgs<T>) => Pick<T, "id" | "parent" | "name" | "params" | "errors" | "createdAt" | "executedAt" | "completedAt" | "state">;
